...
(plot.factor1 <- BoxplotMetadataMOFAfactor(MOFArun.long, "Factor1", "TimepointSimplified", "Latent Factor1", custom_palette_age, custom_palette_age))
(plot.factor2 <- BoxplotMetadataMOFAfactor(MOFArun.long, "Factor2", "TimepointSimplified", "Latent Factor2", custom_palette_2groups, custom_palette_2groups))
