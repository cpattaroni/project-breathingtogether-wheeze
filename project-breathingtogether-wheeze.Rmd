...
rownames(Host.matrix.nasal)[grep("RANTES", rownames(Host.matrix.nasal))]
...
# FCGR1A is CD64
# FCGR3A is CD16
# CD62L (SELL) not detected
# CCL4 amd CCL5 not detected
...
blood.monocytes.cor$r <- ifelse(blood.monocytes.cor$r<0, 0, blood.monocytes.cor$r)
(blood.monocytes.cor <- ggcorrplot(t(blood.monocytes.cor$r), method = "circle", p.mat = t(blood.monocytes.cor$p.adj), 
           insig = "blank",  outline.color = "black", show.diag = TRUE, 
           tl.srt = 90, colors = c("goldenrod3", "white", "#964091")) + 
