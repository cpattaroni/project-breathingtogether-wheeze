...
(plot.factor1.blood.loadings <- MOFAfactorloadings(MOFArun, "Factor1", "Blood", custom_palette_2groups, ntop, "MaCo : Blood host Factor1 MOFA loadings"))
...
(allcells.ann2.umap <- DimPlot(HCLA_data_nose, group.by = "ann_level_2.2", label = TRUE, repel = TRUE, label.size = 5, raster = FALSE,
    ...
    theme(axis.text.x=element_blank(), legend.position = "none", axis.text.y=element_blank(), axis.ticks=element_blank(),
...
Figure5 <- ggarrange(plot1, NA, plot2, NA, plot3, NA, plot4, NA, plot6,
                     ncol = 1, nrow = 9, align = "hv",
                     heights = c(1, 0.1, 1, 0.1, 1, 0.1, 1, 0.1, 1.5),
                     font.label = list(size=label.size))
# Save figure
